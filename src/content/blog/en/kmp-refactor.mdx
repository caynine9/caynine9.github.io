...
**Be wary that these examples focus on the architecture, business logic, and cross-platform compatibility. It gives you the overall idea of how KMP can be implemented in a project and does not reflect how the project was actually implemented.**
